...
{
    sealed class ObservableTransferStatistics : ITransferStatistics
    {
        ...
        public ObservableTransferStatistics(ITransferStatistics defaultStatistics, SynchronizationContext observableSynchronizationContext)
        {
