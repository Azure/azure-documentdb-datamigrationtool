...
namespace Microsoft.DataTransfer.ConsoleHost.DynamicConfiguration
{
    ...
    /// </summary>
    public sealed class DynamicDataAdapterConfigurationFactory : IDataAdapterConfigurationFactory
    {
        ...
        private static readonly MethodInfo ConvertCollectionValueMethod =
            typeof(DynamicDataAdapterConfigurationFactory).GetMethod("ConvertCollectionValue", BindingFlags.Static | BindingFlags.NonPublic);

        private readonly SimpleProxyGenerator proxyGenerator;

        /// <summary>
        /// Creates a new instance of <see cref="DynamicDataAdapterConfigurationFactory" />.
        /// </summary>
        public DynamicDataAdapterConfigurationFactory()
        {
        ...
        private static IEnumerable<T> ConvertCollectionValue<T>(string value)
        {
            ...
            for (var index = 0; index < value.Length; ++index)
            {
                ...
                isEscaping = value[index] == CollectionValuesEscapeCharacter;
            }
